...
namespace XIAOFUTools.Shared.Configuration
{
    ...
    public class UserSettings
    {
        ...
        /// GIS 工具口袋设置
        /// </summary>
        public GisToolPocketSettings GisToolPocket { get; set; } = new GisToolPocketSettings();
    }
    ...
    public class PresetLayersSettings
    {
        ...
        /// 预设图层文件夹路径（相对于程序集位置）
        /// </summary>
        public string LayersPath { get; set; } = @"Assets\Data\影像图层";
    ...
    /// GIS 工具口袋设置
    /// </summary>
    public class GisToolPocketSettings
    {
        /// <summary>
        /// 是否在功能区显示 GIS 工具口袋标签页
        /// </summary>
